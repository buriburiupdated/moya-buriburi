...
An Agent that uses HuggingFace's Inference API
...
class HuggingFaceAgentConfig(AgentConfig):
    """
    Configuration data for an HuggingFaceAgent.
    """
    model_name: str
    task: str
    access_token: Optional[str] = None
    stream_op: Optional[bool] = False
    tool_choice: Optional[str] = None

class HuggingFaceAgent(Agent):
    """
    A simple HuggingFace-based agent that uses the transformers pipeline.
    """
